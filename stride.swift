...
// strideThrough: stride through from 0 to 200 in steps of 10 including 0 and 200(closed range)
for number in stride(from: 0, through: 200, by: 10) {
  // print(number)
}

// StrideTo: stride from 0 to till 256 in steps of 24 not including 256(half closed range)
